...
class Command(BaseCommand):
    ...
    def print_spm(self, parsed):
        ...
        self.stdout.write(f"Total Pembayaran: {meta.get('total_pembayaran') or '-'}")
        self.stdout.write("")
        ...
        self.stdout.write(f"no_spm_from_ocr (halaman SPM): {meta.get('nomor_spm_ocr') or '-'}")
        self.stdout.write(f"no_spp_from_ocr (halaman SPP): {meta.get('nomor_spp') or '-'}")
